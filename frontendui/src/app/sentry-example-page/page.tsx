    ...
    <div>
      ...
      <main>
        ...
        <p className="description">
          ...
          <a
            target="_blank"
            href="https://buildingfullthrotle.sentry.io/issues/?project=4509129433808896"
          >
            Issues Page
          </a>
        ...
        {!config.monitoring.sentry.enabled && (
          <div className="bg-yellow-100 border border-yellow-400 text-yellow-700 px-4 py-3 rounded mt-4">
            ...
            <p className="text-sm">
              Errors will be logged to console only. Enable Sentry in config to
              see them in your Sentry dashboard.
            </p>
          </div>
        )}
        <Button variant="default" onClick={throwRscError} disabled={loading}>
