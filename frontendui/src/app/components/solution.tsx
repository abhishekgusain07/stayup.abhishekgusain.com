  ...
  const comparisonData = [
    {
      ...
      label: "Launch Time",
      value: "1 day",
      comparison: "vs. 4-6 weeks traditional development",
    },
    {
      icon: <CodeIcon />,
      label: "Code to Write",
      value: "90% less",
      comparison: "Focus on your unique features",
    },
    {
      icon: <ClockIcon />,
      label: "Development Time",
      value: "75% faster",
      comparison: "Ship features, not infrastructure",
    },
    {
      icon: <ShieldIcon />,
      label: "Security Features",
      value: "Built-in",
      comparison: "Auth, permissions, data protection",
    },
    {
      icon: <DatabaseIcon />,
      label: "Database Setup",
      value: "Instant",
      comparison: "Pre-configured Neon PostgreSQL",
    },
    {
      icon: <BarChartIcon />,
