      ...
      <div className="hidden lg:flex flex-1 relative overflow-hidden">
        ...
        <div className="relative flex flex-col justify-center items-center p-12 text-white">
          <div className="max-w-md text-center">
            ...
            <h2 className="text-4xl font-bold mb-4">Start Monitoring Today</h2>
            <p className="text-xl text-white/80 mb-8">
              Get instant alerts when your website goes down and keep your users
              happy with 24/7 uptime monitoring
            </p>
