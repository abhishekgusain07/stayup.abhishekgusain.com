      ...
      <NavbarDemo>
        ...
        <section className="relative pt-16 pb-16 px-4 md:px-8 lg:px-16 overflow-hidden">
          ...
          <div className="relative flex flex-col items-center text-center max-w-5xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mb-8 leading-relaxed">
              Get instant alerts when your website goes down. Monitor from multiple locations worldwide and keep your users happy with 24/7 uptime tracking.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              <Link href="/sign-up" className="bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-700 hover:to-blue-700 text-white px-8 py-4 rounded-lg font-medium text-lg shadow-lg shadow-green-500/20 hover:shadow-xl hover:shadow-green-500/30 transition-all transform hover:-translate-y-0.5">
                Start Monitoring Free
              </Link>
              <Link href="#features" className="border-2 border-muted-foreground/20 hover:border-muted-foreground/40 px-8 py-4 rounded-lg font-medium text-lg transition-all hover:bg-muted/20">
                See How It Works
              </Link>
            </div>
            ...
            <div className="w-full max-w-4xl bg-background/80 backdrop-blur-sm border border-border/50 rounded-xl shadow-2xl p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800/30 rounded-lg p-4">
                  ...
                  <div className="text-2xl font-bold text-green-600 dark:text-green-400">98ms</div>
                ...
                <div className="bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800/30 rounded-lg p-4">
                  ...
                  <div className="text-2xl font-bold text-green-600 dark:text-green-400">142ms</div>
                  <div className="text-xs text-muted-foreground">Response time</div>
                </div>
                <div className="bg-green-50 dark:bg-green-950/20 border border-green-200 dark:border-green-800/30 rounded-lg p-4">
                  <div className="flex items-center gap-2 mb-2">
                  ...
                  <div className="text-2xl font-bold text-green-600 dark:text-green-400">234ms</div>
                  <div className="text-xs text-muted-foreground">Response time</div>
                </div>
              </div>
            </div>
        ...
        <section id="features" className="py-16 px-4 md:px-8 lg:px-16 bg-secondary/20">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-4">Comprehensive Uptime Monitoring</h2>
        ...
        <section className="py-16 px-4 md:px-8 lg:px-16 bg-gradient-to-br from-green-50 to-blue-50 dark:from-green-950/20 dark:to-blue-950/20">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">Never Miss Another Downtime</h2>
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Join thousands of developers and businesses who trust StayUp to monitor their websites 24/7. Start your free trial today.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="/sign-up" className="bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-700 hover:to-blue-700 text-white px-8 py-4 rounded-lg font-medium text-lg shadow-lg shadow-green-500/20 hover:shadow-xl hover:shadow-green-500/30 transition-all transform hover:-translate-y-0.5 inline-block">
                Start Free Trial
              </Link>
              <Link href="#pricing" className="border-2 border-muted-foreground/20 hover:border-muted-foreground/40 px-8 py-4 rounded-lg font-medium text-lg transition-all hover:bg-background/50 inline-block">
                View Pricing
              </Link>
            </div>
