...
export class AlertRecipientController {
  ...
  @ApiResponse({
    status: 200,
    description: "Alert recipients retrieved successfully",
  })
  ...
  @ApiResponse({
    status: 201,
    description: "Alert recipient added successfully",
  })
  @ApiResponse({
    status: 400,
  ...
  @ApiResponse({
    status: 200,
    description: "Alert recipient removed successfully",
  })
  @ApiResponse({
    status: 404,
    description: "Monitor or alert recipient not found",
  })
  async deleteAlertRecipient(
    ...
    try {
      ...
      if (
        ...
        error.message === "Alert recipient not found"
      ) {
        return createErrorResponse(error.message);
      }
  ...
  @ApiResponse({
    status: 200,
    description: "Alert recipient status toggled successfully",
  })
  @ApiResponse({
    status: 404,
    description: "Monitor or alert recipient not found",
